...
<div class="card">
	<div class="card-body">
		<div class="card">
			<h5 class="card-header text-white carHeaderBlue" align="center">Técnico ${rol} <br>ANÁLISIS CONTRATACIÓN PÚBLICA</h5>
			<div class="card-body">
				<form:form class="needs-validation" novalidate=""
					id="listarReportes" data-rutaAplicacion="tecnicoNacional"
					data-opcion="ReporteContratacionPublica" data-destino="tabla"
