 ...
 * generated in the gob.cpccs.utilidades.webService.Bsg.registroCivil package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: gob.cpccs.utilidades.webService.Bsg.registroCivil
     * 
     */
