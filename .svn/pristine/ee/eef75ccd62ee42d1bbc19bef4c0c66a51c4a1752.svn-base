<%-- 
	version		: 1.0
    Document  	: Frm_Finalizar_Informe_Gad.jsp
						   ...
						   <div class="row  border-bottom white-bg dashboard-header">
							  ...
							  <ul class="list-group" id="listado">
 									...
 									<form:form class="needs-validation vistaFasePeriodo" novalidate=""
										...
										data-opcion="verificarInformeGad"
                           ...
                           <div class="text-center article-title">
                            ...
                            <p>
                                Le felicita por ser parte del proceso de Rendición de Cuentas para el periodo ${infAutPeriodo}.
 									...
 									<form:form class="needs-validation vistaFasePeriodo" novalidate=""
										modelAttribute="TblInforme" id="finalizarInformeGad"
										data-rutaAplicacion="rendicion"
										data-opcion="FinalizarInformeGad"
										data-accionEnExito="ACTUALIZAR">
                        ...
                        <div class="ibox-content">
                           <div class="text-center article-title">
                            ...
                            <p>
                                ...
                                IMPRIMA SU FORMULARIO, COMO CONSTANCIA DE HABER FINALIZADO SU PROCESO.
                            </p>
 									</div>
 									<form:form class="needs-validation vistaFasePeriodo" novalidate=""
										modelAttribute="TblInforme" id="imprimirInformeGad"
										data-rutaAplicacion="rendicion"
										data-opcion="ImprimirFormulario"
										data-accionEnExito="ACTUALIZAR">
