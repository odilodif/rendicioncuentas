						...
						<div class="table-responsive-xl">
							<table class="table registros table-bordered">
								...
								<tr>
								   ...
								   <td scope="row">
									<label id="mecaniNombre" style="text-align: center; font-size: x-small;">DIÁLOGO</label>
									<input type="hidden" class="form-control form-control-sm campo"  id="cmDescParametro" value="DIÁLOGO" name="cmDescParametro" required="required" disabled="disabled"/>
								   </td>
									<td scope="row"><select class="custom-select custom-select-sm select" style="text-align: center; font-size: x-small;"
											...
											required="required" >
												...
												<option value="INTERACCIÓN DEL MEDIO CON LA CIUDADANÍA">INTERACCIÓN DEL MEDIO CON LA CIUDADANÍA</option>
												<option value="DIÁLOGO INTERCULTURAL Y LA ORGANIZACIÓN DE LOS COLECTIVOS">DIÁLOGO INTERCULTURAL Y LA ORGANIZACIÓN DE LOS COLECTIVOS</option>
									...
									<td scope="row"><input type="url" class="form-control form-control-sm url"  id="cmLink" name="cmLink" required="required" placeholder="Dirección de página web"
											...
											<input type="hidden" id="CmTipo" name="CmTipo" value="DIÁLOGO">
											</td>
