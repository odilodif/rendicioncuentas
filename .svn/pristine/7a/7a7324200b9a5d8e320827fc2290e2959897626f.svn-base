	...
	<div id="Mensaje">
		<div class="alert alert-primary" role="alert">Ingrese uno a uno las registos</div>
			...
			<div class="card card-secondary">
				<form:form class="needs-validation" novalidate="" modelAttribute="TblFuncionesAutoridadesFin" id="FuncionesAutoridadesFin"
				...
				OBSERVACIONES							</td>
					...
					<div class="col-md-12 text-center">
						<button type="submit" id="btnGuardarFuncionG"
...
$(document).ready(function() {
	...
	$("#btnGuardarFuncionG").click(function(event) {
