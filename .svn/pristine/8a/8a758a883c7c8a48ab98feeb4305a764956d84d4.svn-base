...
(function ($) {
    ...
    $.ttwNotificationMenu = function (userOptions) {
        ...
        defaults = {
            ...
            bubble: {
                useColors: true,
                colors: ['#f56c7e', '#fec151', '#23c6c8','#1c84c6','#7ad2f4'],
                showEmptyBubble: true
            },
            showNotificationList: true,
            notificationListEmptyText: 'No tiene Notificaciones',
            defaultCategory: 'general',
            anchor: 'body',
            relativeImagePath: '../imagenes/',
            ...
            notificationClickCallback: function (notification) {
                ...
                notificacioneseditar(notification.idTabla);
            }
        };
        ...
        markup = {
            ...
            notificationBubble: '<span class="notification-bubble" title="Notificaciones"></span>'
        };
        ...
        cssSelector = {
            ...
            notificationListCloseButton: '.close-notification-list,.notification-list-menu,.aplicacion',
        ...
        function isValidReadStatus(type) {
            return ($.inArray(type, ['read', 'unread']) != -1);
        }
                    ...
                    if (!self.notificationList) {
                        self.notificationList = new NotificationList({
                            ...
                            $anchor: (options.notificationList.anchor == 'bubble') ? self.$bubble : self.$item,
                        	    aplicacion:$(this).parents('.aplicacion'),
                        	    color:$(this).parents('.aplicacion').attr("data-color")
                        });
                    }
                });
            }
        ...
        NotificationList = function (notificationListOptions) {
            ...
            this.markup = {
                ...
                notificationListMenu: '<ul class="notification-list-menu">' +
                        '<li id="unread-menu-item" class="notification-list-menu-item">Sin Leer</li>' +
        ...
        NotificationList.prototype.build = function () {
            ...
            this.$wrapper.addClass(this.settings.color+'-border');
            
           
            //aqui se puso esta linea
            $(".notification-list-wrapper").appendTo(this.settings.aplicacion);
        ...
        Notification = function (notificationOptions) {
            ...
            if (typeof notificationOptions == 'string') {
                ...
                this.settings = notificationOptions;
        };
        ...
        Notification.prototype.create = function () {
        	...
        	this.idTabla = this.settings.idTabla;
        ...
        Notification.prototype.html = function () {
            ...
            this.$notification.find(cssSelector.notificationMessage).attr("title",this.message);
            //set the notifications id to the id we just created
            this.$notification.attr('id', this.idTabla);
        ...
        Notification.prototype.setValues = function () {
            ...
            if (typeof this.settings.icon != 'undefined')
                this.$notification.addClass('show-icon').find('.icon')
                        ...
                        .html(markup.notificationIcon).find('img').attr('src', this.settings.icon);
        ...
        notificationMenu.createNotification = function (notificationOptions) {
            ...
            for (var i = 0; i < notificationOptions.length; i++) {
                 ...
                 notification = new Notification(notificationOptions[i]);             
