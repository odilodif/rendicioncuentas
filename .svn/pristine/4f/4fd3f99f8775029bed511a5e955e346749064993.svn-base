...
<div class="card">
	<div class="card-body">
		<div class="card">
			<h5 class="card-header text-white carHeaderBlue" align="center">Técnico ${rol} <br>PROCESO DE RENDICIÓN DE CUENTAS - GADS</h5>
			<div class="card-body">
				<form:form class="needs-validation" novalidate=""
					id="listarReportes" data-rutaAplicacion="tecnicoNacional"
					data-opcion="ReporteProcesosRCGADS" data-destino="tabla"
