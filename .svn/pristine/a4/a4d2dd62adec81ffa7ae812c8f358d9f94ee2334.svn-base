<%-- 
	version		: 1.0
	Document  	: RetroInformeESValorado
	Property   	: CPCCS
	Author		: Jhonatan Alfredo Loor 
	Mail		: jhonatan97loor@gmail.com	
    Date		: 05/10/2022, 7:39
--%>
					...
					<c:if test="${estadoInforme eq true}">
						...
						<div class="card">
							...
							<div class="card-body">
								...
								<div class="form-group row">
									<div class="col-md-9 text-left">
										<label for="pregunta3"><span class="label success">¿LA
												ENTIDAD JUSTIFICA EL CUMPLIMIENTO DE SUS OBLIGACIONES
												TRIBUTARIAS?</span></label>
									</div>
									<p>
										<br />
									</p>
								...
								<div class="form-group row">
									<div class="col-md-9 text-left">
										<label for="pregunta3_1"><span class="label success">¿LA
												ENTIDAD JUSTIFICA EL CUMPLIMIENTO DE SUS OBLIGACIONES
												LABORALES?</span></label>
									</div>
									<p>
										<br />
									</p>
									<div class="col-md-9 text-left">
										<label id="respuesta3_1"></label>
									</div>
								</div>
								<!-- <div class="form-group row">
									<div class="col-md-3 text-left">
						...
						<div class="card">
							...
							<div class="card-body">
								...
								<div class="form-group row">
									<div class="col-md-9 text-left">
										<label for="pregunta5_1"><span class="label success">¿LA
						...
						<div class="card">
							...
							<div class="card-body">
								...
								<div class="form-group row">
									<div class="col-md-9 text-left">
										<label for="pregunta8_1"><span class="label success">¿LA
												ENTIDAD ARGUMENTA LA REALIZACIÓN DE LA(S) POLÍTICAS DE
								...
								<div class="form-group row">
									<div class="col-md-9 text-left">
										<label for="pregunta8_2"><span class="label success">¿LA
												ENTIDAD ARGUMENTA LA REALIZACIÓN DE LA(S) POLÍTICAS DE
								...
								<div class="form-group row">
									<div class="col-md-9 text-left">
										<label for="pregunta8_3"><span class="label success">¿LA
												ENTIDAD ARGUMENTA LA REALIZACIÓN DE LA(S) POLÍTICAS DE
								...
								<div class="form-group row">
									<div class="col-md-9 text-left">
										<label for="pregunta8_4"><span class="label success">¿LA
												ENTIDAD ARGUMENTA LA REALIZACIÓN DE LA(S) POLÍTICAS DE
										...
										function(i, op) {
											...
											case '¿LA ENTIDAD SUSTENTA LA EJECUCIÓN DE SUS CONTRATACIONES PÚBLICAS?':
												...
												if (op.respuesta.includes('1. ') || op.respuesta.includes('2. ') || op.respuesta.includes('3. ') || op.respuesta.includes('4. ') || op.respuesta.includes('5. ') || op.respuesta.includes('6. ') || op.respuesta.includes('7. ')) {
												    ...
												    $('#respuesta2').html(
											    			...
											    			'<li>PRIVADO: INFORME DE EJECUCIÓN DE CONTRATACIONES PÚBLICAS APROBADO POR LA AUTORIDAD COMPETENTE</li>'+
												    		'</ol>'
											...
											case '¿LA ENTIDAD JUSTIFICA EL CUMPLIMIENTO DE SUS OBLIGACIONES TRIBUTARIAS?':
												...
												if (op.respuesta.includes('1. ')) {
												    $('#respuesta3').html('EL MEDIO DE VERIFICACIÓN COLOCADO ES APROPIADO PARA VERIFICAR EL CUMPLIMIENTO DE OBLIGACIONES TRIBUTARIAS DE LA ENTIDAD');
												} else  {
												    $('#respuesta3').html(
											...
											case '¿LA ENTIDAD JUSTIFICA EL CUMPLIMIENTO DE SUS OBLIGACIONES LABORALES?':
												...
												if (op.respuesta.includes('1. ')) {
												    ...
												    $('#respuesta3_1').html('PARA VERIFICAR EL CUMPLIMIENTO DE OBLIGACIONES LABORALES SE DEBE COLOCAR COMO MEDIO DE VERIFICACIÓN EL CERTIFICADO DE NO TENER OBLIGACIONES PENDIENTES CON EL INSTITUTO ECUATORIANO DE SEGURIDAD SOCIAL (IESS)');
												}
												break;
											...
											case '¿LA ENTIDAD SUSTENTA LA EJECUCIÓN DEL ESPACIO DELIBERATIVO?':
												...
												if (op.respuesta.includes('1. ')) {
												    ...
												    $('#respuesta5').html(
												    		'PARA VERIFICAR EL CUMPLIMIENTO DE OBLIGACIONES LABORALES SE DEBE COLOCAR COMO MEDIO DE VERIFICACIÓN EL CERTIFICADO DE NO TENER OBLIGACIONES PENDIENTES CON EL INSTITUTO ECUATORIANO DE SEGURIDAD SOCIAL (IESS)<br>'+
												    		'<ol style="padding-left: 20px; margin: 10px 0;">' +
											...
											case '¿LA ENTIDAD ARGUMENTA LA REALIZACIÓN DE LA(S) POLÍTICAS DE IGUALDAD EN GÉNERO?':
												...
												$('#respuesta8').html('LAS ENTIDADES DEL SECTOR PÚBLICO DEBEN FORMULAR Y ADOPTAR POLÍTICAS PARA ALCANZAR LA IGUALDAD ENTRE HOMBRES Y MUJERES, ADOPTANDO EL ENFOQUE DE GÉNERO EN SUS PLANES Y PROGRAMAS');
												break;
											...
											case '¿LA ENTIDAD SUSTENTA LA EJECUCIÓN DE SU PRESUPUESTO?':
												...
												if (op.respuesta.includes('1. ') || op.respuesta.includes('2. ') || op.respuesta.includes('3. ') || op.respuesta.includes('4. ') || op.respuesta.includes('5. ')){
													$('#respuesta9').html('EL MEDIO DE VERIFICACIÓN COLOCADO ES APROPIADO PARA VERIFICAR LA EJECUCIÓN PRESUPUESTARIA DE LA ENTIDAD');
												}else {
													$('#respuesta9').html(
											    			...
											    			'<li>FORMULARIO DE PAGO DEL IMPUESTO A LA RENTA AL SRI, DONDE EVIDENCIA PÉRDIDAS O GANANCIAS DE LA ENTIDAD</li>'+
											    			'<li>MATRIZ DE LOTAIP QUE SI DIRECCIONA A LA CÉDULA PRESUPUESTARIA</li>'+
											    			'<li>PRIVADO: INFORME OFICIAL DE EJECUCIÓN PRESUPUESTARIA APROBADO POR AUTORIDAD COMPETENTE</li>'+
