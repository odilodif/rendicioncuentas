<%-- 
	version		: 1.0
    Document  	: Frm_EjecutivoMecanismosParticipacion
    Created on	: 22 mar. 2021; 12:39:06
				...
				<div class="row">
					<div class="col-md-12 order-md-1">
						<form:form class="needs-validation" novalidate=""
							...
							<table class="table table-bordered" id="miTabla">
								<thead>
									<tr>
										<th scope="col" class="tablaingreso" width="12%"
											style="font-size: x-small;">MECANISMOS DE PARTICIPACIÓN CIUDADANA</th>
										<th scope="col" class="tablaingreso" width="10%"
											style="font-size: x-small;">PONGA SI
											O NO</th>
										<th scope="col" class="tablaingreso" width="8%"
											style="font-size: x-small;">NÚMERO DE MECANISMOS IMPLEMENTADOS EN EL AÑO</th>
										<th scope="col" class="tablaingreso" width="25%"
											style="font-size: x-small;">MEDIO DE VERIFICACIÓN PUBLICADO EN LA PÁG. WEB DE LA INSTITUCIÓN</th>
								...
								<tbody>
									...
									<tr id="fila1">
										<td scope="row">
										<label id="mecaniNombre">CONSEJOS CONSULTIVOS</label> <input type="hidden" id="mecaNombre[]"
											name="mecaNombre[]" class="form-control form-control-sm"
									...
									<c:choose>
										<c:when test="${Tipo_Formulario!='3' && Tipo_Formulario!='8'  && Tipo_Formulario!='5'}">
										<tr id="fila2">
										<td scope="row">
										<label id="mecaniNombre">CONSEJOS CIUDADANOS SECTORIALES</label> <input type="hidden" id="mecaNombre[]" name="mecaNombre[]" class="form-control form-control-sm"
											value="CONSEJOS CIUDADANOS SECTORIALES">
										</td>
										<td scope="row">
										<select
											class="custom-select custom-select-sm "
									...
									<tr id="fila3">
										<td scope="row"><label id="mecaniNombre">DIÁLOGOS PERIÓDICOS DE DELIBERACIÓN</label> <input type="hidden" id="mecaNombre[]" name="mecaNombre[]" class="form-control form-control-sm"
											value="DIÁLOGOS PERIÓDICOS DE DELIBERACIÓN">
											</td>
										<td scope="row">
										<select
											class="custom-select custom-select-sm "
									...
									<tr id="fila4">
										<td scope="row"><label id="mecaniNombre">AGENDA PÚBLICA DE CONSULTA A LA CIUDADANÍA</label> <input type="hidden" id="mecaNombre[]"
											name="mecaNombre[]" class="form-control form-control-sm"
											value="AGENDA PÚBLICA DE CONSULTA A LA CIUDADANÍA">
											</td>
										<td scope="row"><select
											class="custom-select custom-select-sm "
											id="mecaImplementado[]" name="mecaImplementado[]"
						...
						<c:when test="${Tipo_Formulario=='5'}">
							...
							<tr id="fila3">
										<td scope="row"><label id="mecaniNombre">COMITÉS REGIONALES CONSULTIVOS DE LA EDUCACIÓN SUPERIOR</label> <input type="hidden" id="mecaNombre[]" name="mecaNombre[]" class="form-control form-control-sm"
											value="COMITÉS REGIONALES CONSULTIVOS DE LA EDUCACIÓN SUPERIOR">
											</td>
										<td scope="row">
										<select
											class="custom-select custom-select-sm "
