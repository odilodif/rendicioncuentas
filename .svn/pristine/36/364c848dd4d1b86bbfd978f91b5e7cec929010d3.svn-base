				...
				<form:form class="needs-validation" novalidate=""
					...
					<div class="col-md-12 text-left">
						...
						<table id="ImplePresuGad" class="table registros table-bordered">
							<thead>
							<tr>
								<td class="tablaingreso" style="font-size: x-small;">SE ASIGNÓ UN PORCENTAJE DE LOS
									INGRESOS NO TRIBUTARIOS DEL GAD A LOS GRUPOS DE ATENCIÓN
									PRIORITARIA</td>
									<td class="tablaingreso" style="font-size: x-small;">INDIQUE EL % DEL PRESUPUESTO TOTAL</td>
								<td class="tablaingreso" style="font-size: x-small;">IDENTIFIQUE A QUÉ GRUPO DE
									ATENCIÓN PRIORITARIA</td>
								<td class="tablaingreso" style="font-size: x-small;">QUÉ PORCENTAJE SE ASIGNÓ A LOS
									DISTINTOS GRUPOS</td>
							</tr>
							</thead>
							<tbody>
							<tr>
								<td style="vertical-align: middle; font-size: x-small; width: 250px;" rowspan="13"
									align="center"><select
									...
									<td style="vertical-align: middle; font-size: x-small; width: 100px;" rowspan="13"
									align="center"><input type="number"
									id="porcentajeTotal" name="porcentajeTotal" min="1" max="100" onkeypress="javascript:return validarnro(event);"
									step="0.01" class="form-control form-control-sm numberTotal">
									<div class="invalid-feedback">Ingrese el porcentaje</div></td>
								<td style="font-size: x-small;"><label for="uno"><input type="checkbox"
								...
								<td style="width: 150px; font-size: x-small;"><input type="number" onkeypress="javascript:return validarnro(event);"
									id="porcentaje1" name="porcentaje1" min=1" max="100"
									step="0.01" class="form-control form-control-sm number">
									<div class="invalid-feedback">Ingrese el porcentaje</div></td>
							</tr>
							<tr>
								<td style="font-size: x-small;"><label for="dos"><input type="checkbox"
										class="case" id="cbox2" name="cbox2"
										value="Niñas, niños y adolecentes"> Niñas, niños y
										adolecentes</label>
									<div class="invalid-feedback">Marque el check</div></td>
								<td style="width: 150px; font-size: x-small;"><input type="number"
									id="porcentaje2" name="porcentaje2" min=1" max="100" onkeypress="javascript:return validarnro(event);"
									step="0.01" class="form-control form-control-sm number">
									<div class="invalid-feedback">Ingrese el porcentaje</div></td>
							</tr>
							<tr>
								<td style="font-size: x-small;"><label for="tres"><input type="checkbox"
							...
							<tr>
								<td style="font-size: x-small;"><label for="cuatro"><input type="checkbox"
							...
							<tr>
								<td style="font-size: x-small;"><label for="cinco"><input type="checkbox"
							...
							<tr>
								<td style="font-size: x-small;"><label for="seis"><input type="checkbox"
							...
							<tr>
								<td style="font-size: x-small;"><label for="siete"><input type="checkbox"
							...
							<tr>
								<td style="font-size: x-small;"><label for="ocho"><input type="checkbox"
						...
						<!-- 	<tr>
								<td style="font-size: x-small;"><label for="nueve"><input type="checkbox"
							...
							<tr>
								<td style="font-size: x-small;"><label for="diez"><input type="checkbox"
							...
							<tr>
								<td style="font-size: x-small;"><label for="once"><input type="checkbox"
							...
							<tr>
								<td style="font-size: x-small;"><label for="doce"><input type="checkbox"
							...
							<tr>
								<td style="font-size: x-small;"><label for="trece"><input type="checkbox"
		...
		<c:choose>
			...
			<table id="TablaImplePresu"
				...
				<thead>
					<tr>
						<th>#</th>
						<th style="font-size: x-small;">SE ASIGNÓ UN PORCENTAJE DE LOS INGRESOS NO TRIBUTARIOS DEL GAD A LOS GRUPOS DE ATENCIÓN PRIORITARIA</th>
						<th style="font-size: x-small;">INDIQUE EL % DEL PRESUPUESTO TOTAL</th>
						<th style="font-size: x-small;">IDENTIFIQUE A QUÉ GRUPO DE ATENCIÓN PRIORITARIA</th>
						<th style="font-size: x-small;">QUÉ PORCENTAJE SE ASIGNÓ A LOS DISTINTOS GRUPOS</th>
					</tr>
				</thead>
				<tbody>
				</tbody>				
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$(".numberTotal").prop("disabled", "disabled");
	...
	$("#seleccion").change(function() {
		...
		if (seleccion == "SI") {
			...
			$(".numberTotal").removeAttr("disabled");
			$(".numberTotal").prop("required", true);
			...
			$(".numberTotal").val("0");
			$(".numberTotal").prop("disabled", "disabled");
			$(".numberTotal").removeAttr("required");
		 ...
		 Swal.fire({
			  ...
			  if (result.value) {
				  ...
				  $.ajax({
				        ...
				        type: "POST",
				        dataType: 'json',
				        data: {codigo: codigo,tabla:'esq_rendicioncuentas.tbl_implementacion_presupuesto',campo:'info_cod'},
