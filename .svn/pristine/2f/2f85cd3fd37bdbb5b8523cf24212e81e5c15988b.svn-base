					...
					<form:form class="needs-validation" novalidate=""
						...
						<table class="table registros table-bordered">
								...
								<tr>
									...
									<select class="custom-select custom-select-sm " id="oe_cumple"  onchange="oe_cumpleF()" name="oe_cumple" required="required" >
												<option value="">Seleccione...</option>
												<option value="SI">SI</option>
												<option value="NO">NO</option>
									</select>
	...
	var noobligacion = "S/N";
	  ...
	  if (implemento === "SI"){
			...
			$("#oeObligacion").prop("required", true);
			 $("#oeObligacion").val("");
			$("#oe_acciones").removeAttr('disabled');
			$("#oe_resultados").removeAttr('disabled');	
				
			
		}else if(implemento === "NO"){
		
				  
			$("#oe_acciones").prop("disabled", "disabled");
			  $("#oe_resultados").prop("disabled", "disabled");	
			...
			$("#oeAcciones").val("S/N");
			 ...
			 $("#oeResultados").removeAttr('required');
				...
				$("#oeResultados").val("S/N");

				$("#oe_acciones").val("S/N");
				$("#oe_resultados").val("S/N");
...
function oe_cumpleF(element) {	
	  ...
	  if ($("#oe_cumple").val() === "SI"){
			...
			$("#oe_obligacion").removeAttr('disabled');
			$("#oe_obligacion").prop("required", true);
	
			
		}else if($("#oe_cumple").val() === "NO"){
