<%-- 
	version		: 1.0
    Document  	: Frm_ReporteSistemaParticipacionCiudadana
    Created on	: 9 jun. 2021; 15:24:54 
	...
	<div class="card-body">
			...
			<div class="card-body">
				<form:form class="needs-validation" novalidate=""
					id="listarReportesPartici" data-rutaAplicacion="tecnicoNacional"
					data-opcion="ReporteParticipacion" data-destino="tablaParicipacion"
					data-nombre="Reporte">
