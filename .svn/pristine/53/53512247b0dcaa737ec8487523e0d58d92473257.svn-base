<%-- 
	version		: 1.0
    Document  	: Fmr_ReportePoliticasIgualdad
    Created on	: 1 jun. 2021; 15:42:38 
...
<div class="card">
	<div class="card-body">
			...
			<h5 class="card-header text-white carHeaderBlue" align="center">Técnico ${rol} <br>ANÁLISIS POLITICAS DE IGUALDAD</h5>
			<div class="card-body">
				<form:form class="needs-validation" novalidate=""
					id="listarReportes" data-rutaAplicacion="tecnicoNacional"
					data-opcion="ReportePoliticaIgualdad" data-destino="tablaPolitica"
					data-nombre="Reporte">
