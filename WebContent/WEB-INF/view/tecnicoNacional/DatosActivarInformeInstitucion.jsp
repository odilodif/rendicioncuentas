	...
	<div class="card-body">
		...
		<div class="card card-secondary">
			<form:form class="needs-validation" novalidate=""
							...
							data-opcion="GuardarActivarInforme" data-destino="detalleItem" data-accionEnExito="ACTUALIZAR">
					...
					<div class="form-group row">
						<div class="col-md-2 text-left">
							<label for="CargoResponRegis">Nombre Institución:</label>
						</div>
		...
		<div id="Mensaje">
		<div class="alert alert-primary" role="alert">Recuerde verificar los datos institucionales antes de realizar la apertura del informe</div>
		</div>
