<%-- 
	version		: 1.0
    Document  	: ActivarInformeAutoridad
...
<spring:url value="/resources/" var="urlPublic" />  
   	...
   	<div class="card-body">
   	 ...
   	 <div id="Mensaje">
	<div class="alert alert-primary"role="alert">Buscar por Cédula de Identidad y luego dar doble clic sobre los datos de la Autoridad, para poder activar el informe</div>
	</div>  
	<div class="form-group row">
											<div class="col-md-3 text-left">
												<label for="tipoIdentificacion" class="col-form-label">Ingrese la cédula de la Autoridad</label>
											</div>
											...
											<div class="col-md-3 text-left">
												<input type="text" class="form-control form-control-sm"
													...
													placeholder="9999999999" onchange="validarDocumento(this.value)"  minlength="10" maxlength="10"
													 />
												<div class="invalid-feedback">Por favor ingrese un número de cédula</div>
...
function nacional() {
	...
	$('#tablaRegistros').DataTable({
		ajax : {
			data : parametros,
			url : "obtenerAutoridadConInformeFinalizado",
			headers : {
		...
		createdRow: function( row, data, dataIndex ) {
            $(row).attr('id', data.inf_aut_cod );
            $(row).attr( 'ruc', data.ruc );
            $(row).attr('class', 'item');
            $(row).attr('data-rutaAplicacion', 'tecnicoNacional');
            $(row).attr('data-opcion','DatosActivarInformeAutoridad');
