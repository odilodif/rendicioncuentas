<%-- 
	version		: 1.0
    Document  	: TablaPerilAutoridad
    Created on	: 04/02/2021; 10:14:35
...
<spring:url value="/resources/" var="urlPublic" />  
	...
	<table id="TablaPerilAutoridad" class="table table-striped table-bordered" style="width:100%">
        <thead>
            <tr>
              <th>#</th>
...
var parametros = {
	...
	$('#TablaPerilAutoridad').DataTable( {	     		   
		ajax: {
		     data:parametros,
			url:"obtenerUsuPerfilAutoridad",
