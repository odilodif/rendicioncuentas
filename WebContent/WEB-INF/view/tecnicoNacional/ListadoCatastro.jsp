...
<hr>
	<div class="form-group row">
		<div class="col-md-2 text-rigth">
			<label for="recomendacionInforme">Periodo</label>
		</div>
		<div class="col-md-4 text-left">
			...
			<div class="invalid-feedback">Por favor seleccione el anio</div>
		</div>
		<div class="col-md-4 text-left">
			<button type="submit" class="btn _nuevoColor _buscar btn-sm" id="btnBuscar">Buscar
			</button>
		</div>
	</div>
				...
				<div class="card">
					...
					<div class="card-body">
						<form:form class="needs-validation" novalidate=""
							modelAttribute="TblInstitucion" id="Eliminacion"
							data-rutaAplicacion="tecnicoNacional"
							data-opcion="EliminacionInstitucion" data-destino="detalleItem" data-accionEnExito="ACTUALIZAR">
							<input type="hidden" id="identificadorInstitucion"
								name="identificadorInstitucion">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="card">
					...
					<div class="card-body">
						<form:form class="needs-validation" novalidate=""
							modelAttribute="TblInstitucion" id="Activacion"
							data-rutaAplicacion="tecnicoNacional"
							data-opcion="ActivarInstitucion" data-destino="detalleItem" data-accionEnExito="ACTUALIZAR">
							<input type="hidden" id="identificadorInstitucionAct"
								name="identificadorInstitucionAct">
...
<script>	
		...
		$('#tablaRegistros').DataTable({
			...
			columns : [ 
				{data: "" ,"render": function (data, type, full, meta) {
				 ...
				 {data: "" ,"render": function (data, type, full, meta) {
					 if (full.estado == 'ACTIVO' || full.estado == 'INACTIVO'){
			...
			createdRow : function(row, data, dataIndex) {
                ...
                $(row).attr('data-opcion', 'ActualizarCatastro');	
	...
	function Eliminar(element) {	
		...
		$("#identificadorInstitucion").val(codigo);	
		$("#ruc").val(ruc);	
	...
	function Activar(element) {	
	    ...
	    var ruc = $(element).parent().parent().find("td:eq(2)").text();	
		$("#rucAct").val(ruc);			
		$("#identificadorInstitucionAct").val(codigo);					
	...
	$("#btnBuscar").click(function(event) {		
			 ...
			 if($("#periodo").val() !=""){
				 ...
				 $("#periodo").focus();
				 mostrarMensaje("Por favor seleccionar el periodo!","ERROR");
				 $("#validarP").hide();
