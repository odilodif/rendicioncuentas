<%-- 
	version		: 1.0
    Document  	: Fmr_ReporteMecanismosControlSocial
...
<div class="card">
	<div class="card-body">
			...
			<h5 class="card-header text-white carHeaderBlue" align="center">Técnico ${rol} <br>ANÁLISIS PRESUPUESTO PARTICIPATIVO SOLO GADS</h5>
			<div class="card-body">
				<form:form class="needs-validation" novalidate=""
					id="listarReportes" data-rutaAplicacion="tecnicoNacional"
					data-opcion="ReportePresupuestoParticipativo" data-destino="tablaMecanismo"
					data-nombre="Reporte">
