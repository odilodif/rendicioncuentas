<%-- 
	version		: 1.0
    Document  	: ListaIntitucionesInactivas
    Created on	: 6 abr. 2021; 13:01:19
...
<h5 class="card-header text-white carHeaderBlue" align="center">Técnico ${rol}
	 <br>
	 Listado de Instituciones Inactivas</h5>
...
<script>
	...
	function nacional() {
		var parametros = {"estado" : 'inactivo'};
		$('#tablaRegistros').DataTable({
			ajax : {
				data : parametros,
				url : "obtenerIntitucionesActivasTecNacional",
				headers : {
	...
	function provincial() {
		...
		var parametros = {"provincia" : '${provincia}',"estado" : 'inactivo'};
		$('#tablaRegistros').DataTable({
			ajax : {
				data : parametros,
				url : "obtenerIntitucionesActivasTecProvincial",
				headers : {
					"X-CSRF-TOKEN" : csrfToken
				},
				type : "POST"
