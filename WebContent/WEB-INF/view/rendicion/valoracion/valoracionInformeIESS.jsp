<%-- 
    ...
    Created on	: 07 oct. 2022 10:43:33
		...
		<div class="col-lg-12">
			...
			<div class="tabs-container">
				<ul class="nav nav-tabs nav-pills">
					...
					<li class="nav-item "><a class="nav-link " data-toggle="pill" href="#menu6">Matriz 6</a></li>
					<li class="nav-item "><a class="nav-link " data-toggle="pill" href="#menu7">Matriz 7</a></li>
					<li class="nav-item "><a class="nav-link " data-toggle="pill" href="#menu8">Matriz 8</a></li>
					<li class="nav-item "><a class="nav-link " data-toggle="pill" href="#menu9">Matriz 9</a></li>
				</ul>
					...
					<div id="menu1" class="tab-pane container active">
						<div class="panel-body">
							...
							<form:form class="needs-validation" novalidate=""
								...
								data-opcion="GuardarFrmIessP1" data-destino="detalleItem"
								data-accionEnExito="">
						...
						<div class="card-body">
							...
							<div class="form-group row">
								...
								<div class="col-md-12 text-center">
									<button type="button" id="btnGuardarP1"
					...
					<div id="menu2" class="tab-pane container fade">
						<div class="panel-body">
							...
							<form:form class="needs-validation" novalidate=""
								...
								data-rutaAplicacion="rendicion/valoracion"
								data-opcion="GuardarFrmIessP2" data-destino="detalleItem"
								data-accionEnExito="">
					...
					<div id="menu3" class="tab-pane container fade">
						<div class="panel-body">
							...
							<form:form class="needs-validation" novalidate=""
								...
								data-rutaAplicacion="rendicion/valoracion"
								data-opcion="GuardarFrmIessP3" data-destino="detalleItem"
								data-accionEnExito="">
					...
					<div id="menu4" class="tab-pane container fade">
						<div class="panel-body">
							...
							<form:form class="needs-validation" novalidate=""
								...
								data-rutaAplicacion="rendicion/valoracion"
								data-opcion="GuardarFrmIessP4" data-destino="detalleItem"
								data-accionEnExito="">
					...
					<div id="menu5" class="tab-pane container fade">
						<div class="panel-body">
							...
							<form:form class="needs-validation" novalidate=""
								...
								data-rutaAplicacion="rendicion/valoracion"
								data-opcion="GuardarFrmIessP5" data-destino="detalleItem"
								data-accionEnExito="">
					...
					<div id="menu6" class="tab-pane container fade">
						<div class="panel-body">
							...
							<form:form class="needs-validation" novalidate=""
								...
								data-rutaAplicacion="rendicion/valoracion"
								data-opcion="GuardarFrmIessP6" data-destino="detalleItem"
								data-accionEnExito="">
					...
					<div id="menu7" class="tab-pane container fade">
						<div class="panel-body">
							...
							<form:form class="needs-validation" novalidate=""
								...
								data-rutaAplicacion="rendicion/valoracion"
								data-opcion="GuardarFrmIessP7" data-destino="detalleItem"
								data-accionEnExito="">
					...
					<div id="menu8" class="tab-pane container fade">
						<div class="panel-body">
							...
							<form:form class="needs-validation" novalidate=""
								...
								data-rutaAplicacion="rendicion/valoracion"
								data-opcion="GuardarFrmIessP8" data-destino="detalleItem"
								data-accionEnExito="">
					...
					<div id="menu9" class="tab-pane container fade">
						<div class="panel-body">
							...
							<form:form class="needs-validation" novalidate=""
								...
								data-rutaAplicacion="rendicion/valoracion"
								data-opcion="GuardarFrmIessP9" data-destino="detalleItem"
								...
								<div class="card">
									...
									<div class="card-body">
										<div class="form-group row">
											<div class="col-md-9 text-left">
												<label for="observacion">Describa la o las razones
													que motivaron la evaluación del presente informe, recuerde
													que está observación puede aparecer en el email que será
													remitido a la institución</label>
											</div>

											<textarea rows="4" cols=""
												class="form-control form-control-sm" id="observacion"
												name="observacion" placeholder="Ingrese el comentario aquí"></textarea>
								...
								<div class="col-md-12 text-center">
									<button type="submit" id="btnGuardarP9"
										class="btn _imprimirColor _guardar btn-sm mt-2 Oculta">Finalizar
										Evaluación</button>
								</div>
							</form:form>
			...
			$.each(result.data, function (i, op) {
				...
				case'¿LA ENTIDAD SUSTENTA LA EJECUCIÓN DE SU PRESUPUESTO?':
					$("#pre2").val(op.idInfCal);
					 ...
					 adjuntarEvidencia("cmbPregunta2", "divevidencia2");					
				...
				case'¿LA ENTIDAD SUSTENTA LA EJECUCIÓN DE SUS CONTRATACIONES PÚBLICAS?':
					$("#pre3").val(op.idInfCal);
					 ...
					 adjuntarEvidencia("cmbPregunta3", "divevidencia3");					
					 if(op.evidencia !="N/A" && op.evidencia !=""){								
				...
				case'¿LA ENTIDAD SUSTENTA LA EJECUCIÓN DE MECANISMOS DE PARTICIPACIÓN CIUDADANA?':
					$("#pre4").val(op.idInfCal);
					 ...
					 adjuntarEvidencia("cmbPregunta4", "divevidencia4");					
					 if(op.evidencia !="N/A" && op.evidencia !=""){								
				...
				case'¿LA ENTIDAD SUSTENTA LA EJECUCIÓN DEL ESPACIO DELIBERATIVO?':
					$("#pre5").val(op.idInfCal);
					 ...
					 adjuntarEvidencia("cmbPregunta5", "divevidencia5");					
					 if(op.evidencia !="N/A" && op.evidencia !=""){								
				...
				case'¿LA ENTIDAD SUSTENTA LA GENERACIÓN DE ACUERDOS Y COMPROMISOS CON LA CIUDADANÍA?':
					$("#pre5_1").val(op.idInfCal);
					 ...
					 adjuntarEvidencia("cmbPregunta6", "divevidencia5_1");					
					 if(op.evidencia !="N/A" && op.evidencia !=""){								
				...
				case'¿LA ENTIDAD SUSTENTA LA INCORPORACIÓN DE ACUERDOS Y COMPROMISOS DEL PROCESO PREVIO/ANTERIOR?':
					$("#pre6").val(op.idInfCal);
					 ...
					 adjuntarEvidencia("cmbPregunta7", "divevidencia6");					
					 if(op.evidencia !="N/A" && op.evidencia !=""){								
				...
				case'¿LA ENTIDAD SUSTENTA LA REALIZACIÓN DE MECANISMOS DE CONTROL SOCIAL?':
					$("#pre7").val(op.idInfCal);
					 ...
					 adjuntarEvidencia("cmbPregunta8", "divevidencia7");					
					 if(op.evidencia !="N/A" && op.evidencia !=""){								
