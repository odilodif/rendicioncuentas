                       ...
                       <thead>
								<tr>
									<th scope="col" class="tablaingreso" width="30%"
										style="text-align: center; font-size: x-small;">MECANISMOS ADOPTADOS</th>
									<th scope="col" class="tablaingreso" width="10%"
										style="text-align: center; font-size: x-small;">PONGA SI O NO</th>
						...
						<tbody>	
								<tr id="fila0">
									<td scope="row"><label id="mecaniNombre">PUBLICACIÓN EN LA PÁG. WEB DE LOS CONTENIDOS ESTABLECIDOS EN EL ART. 19 DE LA LOTAIP</label>
										<input type="hidden"  id="mecaniNombre[]" name="mecaniNombre[]" class="form-control form-control-sm"  value="PUBLICACIÓN EN LA PÁG. WEB DE LOS CONTENIDOS ESTABLECIDOS EN EL ART. 19 DE LA LOTAIP">
								...
								<tr id="fila1">
									<td scope="row">
									<label id="mecaniNombre">PUBLICACIÓN EN LA PÁG. WEB DE LOS CONTENIDOS ESTABLECIDOS EN EL ART. 29 DE LA LOTAIP</label>
										<input type="hidden"  id="mecaniNombre[]" name="mecaniNombre[]" class="form-control form-control-sm"  value="PUBLICACIÓN EN LA PÁG. WEB DE LOS CONTENIDOS ESTABLECIDOS EN EL ART. 29 DE LA LOTAIP">
									</td>
									<td scope="row">
									<select class="custom-select custom-select-sm " id="mecaniImplementado[]"  name="mecaniImplementado[]" required="required" >
												<option value="">Seleccione...</option>
								...
								<tr id="fila2">
									<td scope="row">
									<label id="mecaniNombre">HA DIFUNDIDO SUS POLÍTICAS EDITORIALES E INFORMATIVAS</label>
										<input type="hidden"  id="mecaniNombre[]" name="mecaniNombre[]" class="form-control form-control-sm"  value="HA DIFUNDIDO SUS POLÍTICAS EDITORIALES E INFORMATIVAS">
									</td>
									<td scope="row">
									<select class="custom-select custom-select-sm " id="mecaniImplementado[]"  name="mecaniImplementado[]" required="required" >
												<option value="">Seleccione...</option>
								...
								<tr id="fila3">
									<td scope="row">
									<label id="mecaniNombre">HA DIFUNDIDO SU CÓDIGO DEONTOLÓGICO</label>
										<input type="hidden"  id="mecaniNombre[]" name="mecaniNombre[]" class="form-control form-control-sm"  value="HA DIFUNDIDO SU CÓDIGO DEONTOLÓGICO">
									</td>
									<td scope="row">
									<select class="custom-select custom-select-sm " id="mecaniImplementado[]"  name="mecaniImplementado[]" required="required" >
												<option value="">Seleccione...</option>
	...
	<div class="card-body">
	 ...
	 <div id="tabla" class="col-md-12 order-md-1">
				...
				<thead>
					<tr>
						<th >#</th>
						<th width="50%" style="text-align: center; font-size:x-small;">MECANISMOS ADOPTADOS</th>
						<th width="10%" style="text-align: center; font-size:x-small;">PONGA SI O NO</th>
