...
<div class="card text-center mb-card15">
	...
	<div class="card-body">
		...
		<div id="Mensaje">
		<div class="alert alert-primary" role="alert">En el caso de contar con entidades operativas desconsentradas que manejen fondos</div>
		</div>
		<div class="row">
	   ...
	   <tr>
        <th colspan="2">ADMINISTRACIONES TERRITORIALES:</th>
       </tr>
					
					<tr>
					<th class="tablaingreso" width="50%">NOMBRE (Máximo 200 Caracteres)</th>
					<th class="tablaingreso" width="50%">COBERTURA GEOGRÁFICA (Máximo 200 Caracteres)</th>
					<tr>
					<td scope="row">
