<%-- 
	version		: 1.0
    Document  	: Frm_Finalizar_Informe_Autoridad.jsp
                           ...
                           <div class="text-center article-title">
                            ...
                            <p>
                                Le felicita por ser parte del proceso de Rendición de Cuentas para el periodo  ${infAutPeriodo}.
 									...
 									<form:form class="needs-validation vistaFasePeriodo" novalidate=""
										modelAttribute="TblInformeAutoridad" id="finalizarInforme"
										data-rutaAplicacion="rendicion"
										data-opcion="FinalizarInformeAutoridad"
										data-accionEnExito="ACTUALIZAR">
                           ...
                           <div class="text-center article-title">
                            ...
                            <p>
                                ...
                                IMPRIMA SU FORMULARIO, COMO CONSTANCIA DE HABER FINALZIADO SU PROCESO.
 									...
 									<form:form class="needs-validation vistaFasePeriodo" novalidate=""
										modelAttribute="TblInforme" id="imprimirInformeGadEp"
										data-rutaAplicacion="rendicion"
										data-opcion="ImprimirFormularioEp"
										data-accionEnExito="ACTUALIZAR">
                               ...
                               <input type="hidden" id="infAutPeriodo" name="infAutPeriodo" value="${infAutPeriodo}"> 
                                ...
                                <div class="col-md-12 text-center">
											<form:form class="needs-validation" novalidate="" id="Imprimirid" data-rutaAplicacion="rendicion" data-opcion="ImprimirAutoridad" data-destino="detalleItem">
