	...
	<c:choose>
		<c:when test="${inf_estado=='activo'}">
			<div class="card card-secondary">
				<form:form class="needs-validation" novalidate=""
					...
					<h5 class="card-header text-white carHeaderBlue" align="center">ESPACIOS PRODUCCIÓN AUDIOVISUAL INDEPENDIENTE(LOC Art. 97)</h5>
					...
					<div class="col-md-12 text-left">
						...
						<table id="tablaproduccion" class="table registros table-bordered">
							<thead>
							<tr>
							    <td class="tablaingreso" style="font-size: x-small;">CUMPLIMIENTO DE ESPACIOS DE PRODUCCIÓN AUDIOVISUAL INDEPENDIENTE</td>
							...
							<tr>
								<td style="vertical-align: middle; font-size: x-small; width: 150px;" rowspan="6"
									align="center"><label id="mecaniNombre">PRODUCCIÓN NACIONAL INDEPENDIENTE</label> <input type="hidden" id="paTipo"
											name="paTipo" class="form-control form-control-sm"
											value="PRODUCCIÓN NACIONAL INDEPENDIENTE"></td>
									<td style="vertical-align: middle; font-size: x-small; width: 100px;" 
									align="center"><input type="number" min="0"
									id="paPorcentaje" name="paPorcentaje"  max="150" onkeypress="javascript:return validarnro(event);"
							...
							<td style="vertical-align: middle; font-size: x-small; width: 100px;" 
									align="center"><input type="number" min="0"
									id="paPorcentaje" name="paPorcentaje"  max="100" onkeypress="javascript:return validarnro(event);"
									step="0.01" class="form-control form-control-sm numberTotal">
									<div class="invalid-feedback">Ingrese el porcentaje</div></td>
		...
		<c:choose>
			...
			<form:form class="needs-validation" novalidate=""
					...
					data-accionEnExito="ACTUALIZAR">
					<h5 class="card-header text-white carHeaderBlue" align="center">ESPACIOS PRODUCCIÓN AUDIOVISUAL INDEPENDIENTE(LOC Art. 97 y RGLOC Art. 72)</h5>
					<div class="col-md-12 text-left">
			...
			<table id="TablaImplePresu"
				...
				<thead>
					<tr>
						<th>#</th>
						<th style="font-size: x-small;">CUMPLIMIENTO DE ESPACIOS DE PRODUCCIÓN AUDIOVISUAL INDEPENDIENTE</th>
...
<script type="text/javascript">
	...
	function tabla() {
		var parametros = {"infCod" : '${inf_Cod}',"tipo":"PRODUCCIÓN NACIONAL INDEPENDIENTE"};
		 ...
		 Swal.fire({
			  ...
			  if (result.value) {
				  ...
				  $.ajax({
				        ...
				        type: "POST",
				        dataType: 'json',
				        data: {codigo: codigo,tabla:'esq_rendicioncuentas.tbl_produccion_audiovisual',campo:'inf_cod',tipo:"pa_tipo",valor:"PRODUCCIÓN NACIONAL INDEPENDIENTE"},
