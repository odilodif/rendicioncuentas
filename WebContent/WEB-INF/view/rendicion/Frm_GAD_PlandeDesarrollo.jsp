		...
		<c:when test="${inf_estado=='activo'}">
			<div class="card card-secondary">
				<form:form class="needs-validation" novalidate=""
					...
					<h5 class="card-header text-white carHeaderBlue">PLAN DE DESARROLLO Y ORDENAMIENTO TERRITORIAL: REPORTE EL AVANCE RESPECTO A TODOS LOS OBJETIVOS INGRESADOS </h5>
					...
					<tr>
					<td scope="row">
						ELIJA LOS OBJETIVOS DEL PLAN DE DESARROLLO Y ORDENAMIENTO TERRITORIAL
					</td>
						<td scope="row">
			...
			<table id="TablaAvance"
				...
				<thead>
					<tr>
						...
						<th style="font-size: xx-small;">PLAN DE DESARROLLO: REPORTE EL AVANCE RESPECTO A TODOS LOS OBJETIVOS INGRESADOS</th>
						<th style="font-size: xx-small;">PORCENTAJE DE AVANCE ACUMULADO DE LA GESTIÓN DEL OBJETIVO</th>
						<th style="font-size: xx-small;">QUÉ NO SE AVANZÓ Y ¿POR QUÉ?</th>
						<th style="font-size: xx-small;"> </th>
					</tr>
				</thead>
				<tbody>
		 ...
		 $.ajax({
		        ...
		        success: function (msg) {
		            if (msg.estado == "exito") {
	                         ...
	                         var nFilas = $("#TablaAvance tr").length-1;
	                         if (nFilas==0){                            	
