		...
		<div class="row">
			<div class="col-md-12 order-md-1">
				<form:form class="needs-validation" novalidate=""
					modelAttribute="TblInstitucion" id="gestionarActivacion"
					data-rutaAplicacion="rendicion" data-opcion="guardarActivacion"
					...
					<div class="card">
						...
						<div class="card-body">
							...
							<div class="col-md-2 text-left">
									<label for="esServidorPublico">Institución</label>
								</div>
							...
							<div class="form-group row">
								<div class="col-md-2 text-left">
									<label for="parroquia">Número de Ruc</label>
								</div>
								<div class="col-md-2  text-left">
									<input type="text" class="form-control form-control-sm"
							...
							<div class="form-group row">
								<div class="col-md-2 text-left">
									<label for="parroquia">Función</label>
								</div>
								<div class="col-md-4  text-left">
									<input type="text" class="form-control form-control-sm"
										disabled id="ingreso" name="ingreso" value="${instInfo.instFunCod.funDes}" />

								</div>								
							</div>
							<div class="form-group row">
								<div class="col-md-2 text-left">
									<label for="parroquia">Descripción</label>
								</div>
								<div class="col-md-8  text-left">
									<input type="text" class="form-control form-control-sm"
										disabled id="ingreso" name="ingreso" value="${instInfo.instDesUdaf}" />

								</div>								
							</div>
							<div class="form-group row">
								<div class="col-md-2 text-left">
									<label for="parroquia">Nombre del Representante</label>
								</div>
								<div class="col-md-4  text-left">
									<input type="text" class="form-control form-control-sm"
										disabled id="ingreso" name="ingreso" value="${representante}" />
						...
						<div class="form-group row">
							...
							<div class="col-md-2 text-center">
								<button type="submit" id="btnGuardaraprobar"
									class="btn _nuevoColor _aprobar btn-sm mt-2">Aceptar Institución</button>
							</div>
							
							<div class="col-md-2 text-center">
								<button type="button" id="btnGuardarRechazar"
									class="btn _seleccionarColor _negar btn-sm mt-2">Negar Institución </button>
							</div>
							...
							<div class="form-group row">
								<div class="col-md-2 text-left">
									<label for="archivoAdjunto">Ruc Archivo</label>
								</div>
...
<!-- 												aquí para ver archivo</a> -->
										...
										<c:otherwise>
										<%-- 	<img src="${rutaArchivosAplicacion}${archivoRespaldo}" class="img-fluid"  width="500px"
                                           height="500px"/> --%>
                                           <iframe id="inlineFrameExample"
                                          title="Inline Frame Example"
                                           width="500px"
	...
	<div class="modal fade bd-example-modal-sm" id="Historial" tabindex="-1" role="dialog" >
	<div class="modal-dialog modal-camm" role="document">
		<div class="modal-content">
			<div class="modal-header">	
				<h5 class="modal-title" id="HistorialLabel">Negar Institución</h5>
			...
			<div class="modal-body">
				...
				<span aria-hidden="true"></span>
						...
						<form:form class="needs-validation" novalidate=""
							...
							data-opcion="GuardarNegacion" data-destino="detalleItem" data-accionEnExito="ACTUALIZAR">
...
if (form[0].checkValidity() === false  ) {
	mostrarMensaje("Por favor ingrese toda la información solicitada!","ERROR")
			...
			ejecutarJson(form);   
			$("#Historial").modal('hide');//ocultamos el modal
