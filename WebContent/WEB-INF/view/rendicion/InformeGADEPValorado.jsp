										...
										function(i, op) {
											...
											case '¿LA ENTIDAD SUSTENTA LA EJECUCIÓN DE SU PRESUPUESTO?':
												...
												if (op.evidencia != "N/A"
														&& op.evidencia != ""
														&& op.evidencia != null) {
													$("#respuestaConArchivo2")
															.show()
													$('#respuestaConArchivo2')
															.attr(
																	'href',
																	'${rutaArchivosAplicacion}'
																			+ op.evidencia);

												} else {
													$("#respuestaSinArchivo2")
															.show();
												}
												break;
