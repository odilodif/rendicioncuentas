			...
			<div class="col-md-12 order-md-1">
				<form:form class="needs-validation" novalidate=""
					...
					<c:if test="${estadoInforme eq true}">
						...
						<div class="card">
							...
							<div class="card-body">
								...
								<div class="form-group row">
									...
									<div class="col-md-9 text-left">
										<label id="respuesta3">${respuesta3}</label>
									</div>
								</div>
								<%-- <div class="form-group row">
									<div class="col-md-3 text-left">
						...
						<div class="card">
							...
							<div class="card-body">
								...
								<div class="form-group row">
									...
									<div class="col-md-9 text-left">
										<label id="respuesta4">${respuesta4}</label>
									</div>
						...
						<div class="card">
							...
							<div class="card-body">
								...
								<div class="form-group row">
									...
									<div class="col-md-9 text-left">
										<label id="respuesta5">${respuesta5}</label>
									</div>
								</div>
								<%-- <div class="form-group row">
									<div class="col-md-3 text-left">
								...
								<div class="form-group row">
									...
									<div class="col-md-9 text-left">
										<label id="respuesta6">${respuesta6}</label>
									</div>
								</div>
								<%-- <div class="form-group row">
									<div class="col-md-3 text-left">
						...
						<div class="card">
							...
							<div class="card-body">
								...
								<div class="form-group row">
									...
									<div class="col-md-9 text-left">
										<label id="respuesta7">${respuesta7}</label>
									</div>
								</div>
								<%-- <div class="form-group row">
									<div class="col-md-3 text-left">
						...
						<p></p>
						<div class="card">
							<h5 class="card-header text-white carHeaderBlue">PROCESO DE	RENDICIÓN DE CUENTAS</h5>
							<div class="card-body">
								...
								<div class="form-group row">
									...
									<div class="col-md-9 text-left">
										<label id="respuesta9">${respuesta9}</label>
									</div>
								</div>
								<%-- <div class="form-group row">
									<div class="col-md-3 text-left">
						...
						<div class="card">
							...
							<div class="card-body">
									...
									<thead>
										<tr>
											...
											<th style="font-size: x-small;">PORCENTAJE DE AVANCES DE
												CUMPLIMIENTO</th>
											<th style="font-size: x-small;">DESCRIPCIÓN DE
												RESULTADOS</th>
								...
								<div class="form-group row">
									...
									<div class="col-md-9 text-left">
										<label id="respuesta10">${respuesta10}</label>
									</div>
								</div>
								<%-- <div class="form-group row">
									<div class="col-md-3 text-left">
						...
						<div class="card">
							...
							<div class="card-body">
								...
								<div class="form-group row">
									...
									<div class="col-md-9 text-left">
										<label id="respuesta11">${respuesta11}</label>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="card">
							...
							<div class="card-body">
								...
								<div class="form-group row">
									...
									<div class="col-md-9 text-left">
										<label id="respuesta12">${respuesta12}</label>
									</div>
								</div>
								...
								<div class="form-group row">
									...
									<div class="col-md-9 text-left">
										<label id="respuesta14">${respuesta14}</label>
									</div>
								</div>

								<div class="form-group row">
									<div class="col-md-9 text-left">
										<label id="pregunta15"><span class="label success">¿LA
												ENTIDAD ARGUMENTA LA REALIZACIÓN DE LA(S) POLÍTICAS DE
									...
									<div class="col-md-9 text-left">
										<label id="respuesta15">${respuesta15}</label>
									</div>
								</div>
								...
								<div class="form-group row">
									<div class="col-md-9 text-left">
										<label id="pregunta16"><span class="label success">¿LA
												ENTIDAD ARGUMENTA LA REALIZACIÓN DE LA(S) POLÍTICAS DE
									...
									<div class="col-md-9 text-left">
										<label id="respuesta16">${respuesta16}</label>
									</div>
								</div>
							</div>
						</div>
								...
								.each(
										...
										function(i, op) {
											...
											case '¿LA ENTIDAD SUSTENTA LA EJECUCIÓN DE SU PRESUPUESTO?':
												...
												if (op.respuesta.includes('1. ') || op.respuesta.includes('2. ') || op.respuesta.includes('3. ') || op.respuesta.includes('4. ') || op.respuesta.includes('5. ') || op.respuesta.includes('7. ')) {
											...
											case '¿LA ENTIDAD SUSTENTA LA EJECUCIÓN DE SUS CONTRATACIONES PÚBLICAS?':
												...
												if (op.respuesta.includes('1. ')) {
												    $('#respuesta4').html('EL MEDIO DE VERIFICACIÓN COLOCADO ES APROPIADO PARA VERIFICAR EL BALANCE GENERAL DE LA ENTIDAD');
												} else {
												    $('#respuesta4').html('SE DEBE COLOCAR EL BALANCE GENERAL DE LA ENTIDAD PARA SU VERIFICACIÓN');
												}
												break;
											case '¿LA EMPRESA PÚBLICA PRESENTA INFORMACIÓN DE CUMPLIMIENTO DE OBLIGACIONES TRIBUTARIAS?':
												...
												if (op.respuesta.includes('1. ') || op.respuesta.includes('2. ')) {
												    ...
												    $('#respuesta5').html(
											                'SI SU ENTIDAD MANEJA RECURSOS PÚBLICOS SE DEBEN REPORTAR LAS CONTRATACIONES PÚBLICAS. PARA SU VERIFICACIÓN DEBE COLOCAR ALGUNO DE LOS SIGUIENTES DOCUMENTOS COMO MEDIO DE VERIFICACIÓN:  <br>' +
											                '<ol style="padding-left: 20px; margin: 10px 0;">' +
											                '<li>PARA VERIFICAR EL CUMPLIMIENTO DE OBLIGACIONES TRIBUTARIAS SE DEBE COLOCAR ALGUNO DE LOS SIGUIENTES DOCUMENTOS COMO MEDIO DE VERIFICACIÓN: </li>' +
											...
											case '¿LA EMPRESA PÚBLICA PRESENTA INFORMACIÓN DE CUMPLIMIENTO DE OBLIGACIONES LABORALES?':
												...
												if (op.respuesta.includes('1. ')) {
												    ...
												    $('#respuesta6').html('PARA VERIFICAR EL CUMPLIMIENTO DE OBLIGACIONES LABORALES SE DEBE COLOCAR COMO MEDIO DE VERIFICACIÓN EL CERTIFICADO DE NO TENER OBLIGACIONES PENDIENTES CON EL INSTITUTO ECUATORIANO DE SEGURIDAD SOCIAL (IESS)');
												}
												break;
											case '¿LA ENTIDAD SUSTENTA LA EJECUCIÓN DE MECANISMOS DE PARTICIPACIÓN CIUDADANA?':
												...
												if (op.respuesta.includes('1. ') || op.respuesta.includes('2. ')) {
												    ...
												    $('#respuesta7').html('EL MEDIO DE VERIFICACIÓN COLOCADO ES APROPIADO PARA VERIFICAR EL CUMPLIMIENTO DE OBLIGACIONES LABORALES DE LA ENTIDAD');
												} else {
												    $('#respuesta7').html('PARA VERIFICAR EL CUMPLIMIENTO DE OBLIGACIONES LABORALES SE DEBE COLOCAR COMO MEDIO DE VERIFICACIÓN EL CERTIFICADO DE NO TENER OBLIGACIONES PENDIENTES CON EL INSTITUTO ECUATORIANO DE SEGURIDAD SOCIAL (IESS)');
												}
												break;
											...
											case '¿LA ENTIDAD SUSTENTA LA GENERACIÓN DE ACUERDOS Y COMPROMISOS CON LA CIUDADANÍA?':
												...
												if (op.respuesta.includes('1. ') || op.respuesta.includes('2. ')) {
												    $('#respuesta9').html('EL MEDIO DE VERIFICACIÓN COLOCADO ES APROPIADO PARA VERIFICAR LA EJECUCIÓN DE ACUERDOS Y COMPROMISOS CON LA CIUDADANÍA EN EL PROCESO DE RENDICIÓN DE CUENTAS');
												} else {
												    $('#respuesta9').html(
											...
											case '¿LA ENTIDAD SUSTENTA LA INCORPORACIÓN DE ACUERDOS Y COMPROMISOS DEL PROCESO PREVIO/ANTERIOR?':
												...
												if (op.respuesta.includes('1. ')) {
												    $('#respuesta10').html('EL MEDIO DE VERIFICACIÓN COLOCADO ES APROPIADO PARA VERIFICAR LA EJECUCIÓN DE ACUERDOS Y COMPROMISOS CON LA CIUDADANÍA EN EL PROCESO DE RENDICIÓN DE CUENTAS');
												} else if (op.respuesta.includes('3. ')) {
												    $('#respuesta10').html('SI SU ENTIDAD MANEJA RECURSOS PÚBLICOS SE DEBE REPORTAR LA INCORPORACIÓN DE ACUERDOS Y COMPROMISOS DEL PROCESO PREVIO/ANTERIOR. LAS ENTIDADES DEBEN REALIZAR CONVOCATORIAS PREVIAS Y AMPLIAS A SUS PROCESOS DE RENDICIÓN DE CUENTAS Y DEBEN PROPENDER A INCENTIVAR EL DEBATE SOBRE LA GESTIÓN REPORTADA EN SUS ESPACIOS DELIBERATIVOS.');
												} else {
												    $('#respuesta10').html(
												        'PARA VERIFICAR LA EJECUCIÓN DE ACUERDOS Y COMPROMISOS CON LA CIUDADANÍA SE DEBE COLOCAR ALGUNO DE LOS SIGUIENTES DOCUMENTOS COMO MEDIO DE VERIFICACIÓN:<br>' +
												        '<ol style="padding-left: 20px; margin: 10px 0;">' +
											...
											case '¿LA ENTIDAD ARGUMENTA LA REALIZACIÓN DE LA(S) POLÍTICAS DE IGUALDAD INTERCULTURAL?':
												...
												if (op.respuesta.includes('1. ') || op.respuesta.includes('2. ')) {
												    ...
												    $('#respuesta15').html(
												        'LAS ENTIDADES DEL SECTOR PÚBLICOS DEBEN ADOPTAR MEDIDAS PARA PROMOVER EL EJERCICIO DE DERECHOS DE LAS PERSONAS, APLICANDO EL PRINCIPIO DE INTERCULTURALIDADL');
												}
