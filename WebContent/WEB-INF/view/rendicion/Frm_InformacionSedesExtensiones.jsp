...
<div class="card text-center mb-card15">
	<c:choose>
						...
						<table class="table registros table-bordered">
							...
							<tr>
								...
								<td scope="row" colspan="6"><input type="text"
									...
									placeholder="INGRESE LA COBERTURA GEOGRÁFICA" minlength="3" maxlength="64"
									value="">
									<div class="invalid-feedback">Por favor ingrese el Cargo</div>
								</td>
							</tr>
							<tr>
								...
								<td scope="row" colspan="6"><input type="number"
									...
									minlength="20" maxlength="13" step "1" min="1"
									pattern="^([a-zA-Z0-9]{7,13})+$" 
									onkeypress="mascaraEnteros(this)" onpaste="return false"/>
									<div class="invalid-feedback">Por favor ingrese el número</div>
								</td>
							...
							<tr>
								...
								<td scope="row" colspan="6"><input type="number"
									...
									minlength="20" maxlength="13" step "1" min="0"
		...
		<c:when test="${inf_estado=='matriz'}">
			...
			<table id="TablaSedes" class="table table-striped table-bordered" 
			style="width: 100%" >
				<thead>
					<tr>
						<th class="tablaingreso" style="font-size: xx-small;">#</th>
						<th class="tablaingreso" style="font-size: xx-small;">NOMBRE DE LA EXTENSIÓN O SEDE</th>
						<th class="tablaingreso" style="font-size: xx-small;">PROVINCIA</th>
						<th class="tablaingreso" style="font-size: xx-small;">CANTÓN</th>
						<th class="tablaingreso" style="font-size: xx-small;">PARROQUIA</th>
						<th class="tablaingreso" style="font-size: xx-small;">DIRECCIÓN</th>
						<th class="tablaingreso" style="font-size: xx-small;">CORREO</th>
						<th class="tablaingreso" style="font-size: xx-small;">PÁGINA WEB</th>
						<th class="tablaingreso" style="font-size: xx-small;">Nro. RUC</th>
						<th class="tablaingreso" style="font-size: xx-small;"></th>
						<th class="tablaingreso" style="font-size: xx-small;"></th>
				...
				<table id="TablaSedesDetalle" class="table table-striped table-bordered" 
			style="width: 100%" >
				<thead>
					<tr>
						<th class="tablaingreso" style="font-size: xx-small;">#</th>
						<th class="tablaingreso" style="font-size: xx-small;">EXTENSIÓN O SEDE</th>
						<th class="tablaingreso" style="font-size: xx-small;">NOMBRE DEL REPRESENTANTE LEGAL</th>
						<th class="tablaingreso" style="font-size: xx-small;">CARGO</th>
						<th class="tablaingreso" style="font-size: xx-small;">FECHA</th>
						<th class="tablaingreso" style="font-size: xx-small;">CORREO</th>
						<th class="tablaingreso" style="font-size: xx-small;">TELÉFONO</th>
						<th class="tablaingreso" style="font-size: xx-small;"></th>
					</tr>
				</thead>
				<tbody>
			...
			<table id="TablaSedesDetalle2" class="table table-striped table-bordered" 
			style="width: 100%" >
				<thead>
				<tr>
						<th class="tablaingreso" rowspan="2" style="vertical-align: middle; font-size: x-small;">#</th>
						<th class="tablaingreso" rowspan="2" style="vertical-align: middle; font-size: x-small;">EXTENSIÓN O SEDE</th>
						<th class="tablaingreso" rowspan="2" style="vertical-align: middle; font-size: x-small;">Nro UNIDADES (CAMPUS)</th>
						<th class="tablaingreso" rowspan="2" style="vertical-align: middle; font-size: x-small;">COBERTURA GEOGRÁFICA</th>
						<th class="tablaingreso" rowspan="2" style="vertical-align: middle; font-size: x-small;">Nro ESTUDIANTES</th>
						<th class="tablaingreso" colspan="3" style="font-size: x-small;">GÉNERO</th>
						<th class="tablaingreso" colspan="6" style="font-size: x-small;">NACIONALIDADES O PUEBLOS</th>
						<th class="tablaingreso" rowspan="2" style="vertical-align: middle; font-size: x-small;">Nro ESTUDIANTES DICAPACITADOS </th>
						<th class="tablaingreso" rowspan="2" style="vertical-align: middle; font-size: x-small;">LINK </th>
   						<th class="tablaingreso" rowspan="2" style="vertical-align: middle; font-size: x-small;"></th>
					</tr>
					<tr>
						<th class="tablaingreso" style="font-size: xx-small;">MASCULINO</th>
						<th class="tablaingreso" style="font-size: xx-small;">FEMENINO</th>
						<th class="tablaingreso" style="font-size: xx-small;">GLBTI</th>
						<th class="tablaingreso" style="font-size: xx-small;">MONTUBIO</th>
						<th class="tablaingreso" style="font-size: xx-small;">MESTIZO</th>
						<th class="tablaingreso" style="font-size: xx-small;">CHOLO</th>
						<th class="tablaingreso" style="font-size: xx-small;">INDIGENA</th>
						<th class="tablaingreso" style="font-size: xx-small;">AFROECUATORIANO</th>
						<th class="tablaingreso" style="font-size: xx-small;">EXTRANJEROS</th>
					</tr>
				</thead>
				<tbody>
				</tbody>
...
<script type="text/javascript">
	...
	function Eliminar(element) {	
		var codigo = $(element).closest('tr').attr('id');	
		 $.ajax({
		        ...
		        type: "POST",
		        dataType: 'json',
		        data: {codigo: codigo,tabla:'esq_rendicioncuentas.tbl_sede',campo:'se_cod'},
		        success: function (msg) {
		            if (msg.estado == "exito") {
	                         ...
	                         var nFilas = $("#TablaSedes tr").length-1;
	                         if (nFilas==0){                            	
		...
		columns : [
			...
			{ data: "" ,"render": function (data, type, full, meta) {
				 if('${infestadoinforme}' === "finalizado"){
	                ...
	                data = '<button type="button" id="Editar" class="_modificar btn _actualizarColor btn-xs"  onclick="ActualizarSede(this)" title="Editar Registro" data-toggle="tooltip" data-placement="bottom" style="font-size:x-small;"> Editar</button>';    
	             }return data;
	    }},
			...
			{ data: "" ,"render": function (data, type, full, meta) {
				if('${infestadoinforme}' === "finalizado"){
		            ...
		            data = '<button type="button" id="Eliminar" class="_eliminar btn _eliminarColor" data-toggle="modal" data-target="#modalEliminar" style="font-size: xx-small;" onclick="Eliminar(this)" title="Eliminar Registro" data-toggle="tooltip" data-placement="bottom"> Eliminar</button>';    
	             }
		     return data;
	        }}
			],	
			...
			createdRow : function(row, data, dataIndex) {
				$(row).attr('id', data.se_cod);
				//$(row).attr('class', 'item');
			    $(row).attr('data-rutaAplicacion', 'rendicion');
				$(row).attr('data-opcion', 'Frm_InformacionSedesExtensionesActualizarSede');
	...
	function tablaDetalle() {
		var parametros = {"infCod" : '${infCod}'};
		$('#TablaSedesDetalle').DataTable({
		ajax : {
		
		data : parametros,
		url : "obtenerSedesDetalle",
		headers : {"X-CSRF-TOKEN" : csrfToken},
		type : "POST"	},
        order : [ 0, "asc" ],		
        paging:   false,
		...
		columns : [
			...
			{ data: "" ,"render": function (data, type, full, meta) {
				if('${infestadoinforme}' === "finalizado"){
		            ...
		            data = '<button type="button" id="Editar" class="_modificar btn _actualizarColor" data-toggle="modal" data-target="#modalEliminar" style="font-size: xx-small;" onclick="ActualizarDetalle(this)" title="Editar Registro" data-toggle="tooltip" data-placement="bottom"> Editar</button>';    
	             }
		     return data;
	        }}
			],	
			...
			createdRow : function(row, data, dataIndex) {
				...
				//$(row).attr('class', 'item');
			    $(row).attr('data-rutaAplicacion', 'rendicion');
				$(row).attr('data-opcion', 'Frm_InformacionSedesExtensionesActualizarSedeDetalle');
				$(row).attr('ondragstart', 'drag(event)');
				$(row).attr('draggable', 'false');
				$(row).attr('data-destino', 'detalleItem');
				$(row).find("td:first").css({
	...
	function tablaDetalle2() {
		var parametros = {"infCod" : '${infCod}'};
		$('#TablaSedesDetalle2').DataTable({
		ajax : {
		data : parametros,
		url : "obtenerSedesDetalle2",
		headers : {"X-CSRF-TOKEN" : csrfToken},
		type : "POST"	},
        order : [ 0, "asc" ],		
        paging:   false,
		...
		columns : [
			...
			{ data: "" ,"render": function (data, type, full, meta) {
				if('${infestadoinforme}' === "finalizado"){
	            	 data = '';     
			            ...
			            data = '<button type="button" id="Editar" class="_modificar btn _actualizarColor" data-toggle="modal" data-target="#modalEliminar" style="font-size: xx-small;" onclick="ActualizarDetalle2(this)" title="Editar Registro" data-toggle="tooltip" data-placement="bottom"> Editar</button>';    
	             }
		     return data;
	        }}
			],	
			...
			createdRow : function(row, data, dataIndex) {
				...
				//$(row).attr('class', 'item');
			    $(row).attr('data-rutaAplicacion', 'rendicion');
				$(row).attr('data-opcion', 'Frm_InformacionSedesExtensionesActualizarSedeDetalle2');
				$(row).attr('ondragstart', 'drag(event)');
				$(row).attr('draggable', 'false');
				$(row).attr('data-destino', 'detalleItem');
				$(row).find("td:first").css({
	...
	validarDocumento  = function() {          		
	   ...
	   function ActualizarSede(element) {	
			$('#TablaSedes tbody').on('click', 'tr', function() {
	   ...
	   function ActualizarDetalle(element) {	
			$('#TablaSedesDetalle tbody').on('click', 'tr', function() {
				abrir($(this), "#" + $(this).attr("data-destino"), false);
			});
				
		}
		function ActualizarDetalle2(element) {	
			$('#TablaSedesDetalle2 tbody').on('click', 'tr', function() {
				abrir($(this), "#" + $(this).attr("data-destino"), false);
			});
		}
