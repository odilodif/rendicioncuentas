						...
						<div class="table-responsive-xl">
							<table class="table registros table-bordered">
								...
								<tr>
								   ...
								   <td scope="row">
									<label id="mecaniNombre" style="text-align: center; font-size: x-small;">PROMOCIÓN DE DERECHOS</label>
									<input type="hidden" class="form-control form-control-sm campo"  id="cmDescParametro" value="PROMOCIÓN DE DERECHOS" name="cmDescParametro" required="required" disabled="disabled"/>
								   </td>
									...
									<td scope="row"><input type="text"
										...
										name="cmPorcDifusion" required="required" onkeypress="javascript:return validardecimal(event);"  placeholder="00.00" maxlength="5"/>
									...
									<td scope="row"><input type="url" class="form-control form-control-sm url"  id="cmLink" name="cmLink" required="required" placeholder="Dirección de página web"
											...
											<input type="hidden" id="CmTipo" name="CmTipo" value="PROMOCIÓN DE DERECHOS">
											</td>
								...
								<tr>
								   ...
								   <td scope="row">
									...
									<td scope="row"><input type="text"
										...
										name="cm_porc_difusion" required="required" onkeypress="javascript:return validardecimal(event);"  placeholder="00.00" maxlength="5"/>
										<div class="invalid-feedback">Por Ingrese el Porcentage</div></td>
