...
// función 
function ajustarAltoIngreso() {
  var navbarHeigh = $('.card-header').height();
  var wrapperHeigh = $('.card-body').height();
  if (navbarHeigh > wrapperHeigh) {
    $('.card-body').css("min-height", navbarHeigh + "px");
	}

	if (navbarHeigh < wrapperHeigh) {
	  $('.card-body').css("min-height", ($(window).height() - 108) + "px");
	}
}
...
function ajustarAltoVentanaAplicacion() {
   ...
   header = $("#card-header").height();
   footer = $("#card-footer").height();
     $("#card-body").height($(window).height() - header - footer - 85  );
