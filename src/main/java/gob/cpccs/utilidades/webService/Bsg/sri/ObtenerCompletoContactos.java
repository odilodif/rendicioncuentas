...
/**
 * <p>Clase Java para obtenerCompletoContactos complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="obtenerCompletoContactos">
 *   &lt;complexContent>
...
@XmlType(namespace="http://www.test12.com",name = "obtenerCompletoContactos", propOrder = {
    "numeroRuc"
})
public class ObtenerCompletoContactos {
